...
from org.apache.lucene.search.similarities import BM25Similarity  # Change here
...
try:
    ...
    with closing(DirectoryReader.open(FSDirectory.open(index_path))) as reader:
        # Use BM25Similarity instead of ClassicSimilarity (Okapi BM25)
        searcher = IndexSearcher(reader)
        searcher.setSimilarity(BM25Similarity())  # Change here
