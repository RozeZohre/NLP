...
from org.apache.lucene.search.similarities import DFRSimilarity, BasicModelBE, AfterEffectL, NormalizationH2
...
try:
    ...
    with closing(DirectoryReader.open(FSDirectory.open(index_path))) as reader:
        # Use DFRSimilarity with different components
        searcher = IndexSearcher(reader)
        searcher.setSimilarity(DFRSimilarity(BasicModelBE(), AfterEffectL(), NormalizationH2()))
