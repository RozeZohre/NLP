...
from org.apache.lucene.search.similarities import ClassicSimilarity  # Change the import
...
try:
    ...
    with closing(DirectoryReader.open(FSDirectory.open(index_path))) as reader:
        ...
        searcher.setSimilarity(ClassicSimilarity())  # Change to ClassicSimilarity
